...
namespace Peach.Pro.Core.Mutators.MQTT
{
    ...
    public class MqttUnsubscribeMutatePacketIdentifier : Mutator
    {
         ...
         public new static bool supportedDataElement(DataElement obj) { return obj is Number && obj.Name == "packet_identifier" && obj.parent != null && obj.parent.Name.Contains("unsubscribe"); }
    ...
    public class MqttUnsubscribeMutateProperties : Mutator
    {
        ...
        public new static bool supportedDataElement(DataElement obj) { return obj is Blob && obj.Name == "properties" && obj.parent != null && obj.parent.Name.Contains("unsubscribe"); }
    ...
    public class MqttUnsubscribeMutateTopicFilters : Mutator
    {
        ...
        public new static bool supportedDataElement(DataElement obj) { 
            return obj is Peach.Core.Dom.Block && obj.Name == "topic_filters" && obj.parent != null && obj.parent.Name.Contains("unsubscribe");
        }
        public override int count => 10; 
        public override uint mutation { get; set; }
        public override void sequentialMutation(DataElement obj) { PerformMutation(obj, (int)mutation); obj.mutationFlags = MutateOverride.Default; }
