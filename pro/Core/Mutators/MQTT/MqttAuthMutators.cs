...
namespace Peach.Pro.Core.Mutators.MQTT
{
    ...
    public class MqttAuthMutateReasonCode : Mutator
    {
         ...
         public new static bool supportedDataElement(DataElement obj) { return obj is Number && obj.Name == "reason_code" && obj.parent != null && obj.parent.Name == "mqtt_auth_variable_header_t"; }
    ...
    public class MqttAuthMutateProperties : Mutator
    {
        ...
        public new static bool supportedDataElement(DataElement obj) { return obj is Blob && obj.Name == "properties" && obj.parent != null && obj.parent.Name == "mqtt_auth_variable_header_t"; }
